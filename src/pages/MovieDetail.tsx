...
const MovieDetail = () => {
  ...
  const { isInWatchlist, isLoading: watchlistLoading, toggleWatchlist } = useWatchlist(undefined, id)
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className="relative left-0 top-0 w-full h-auto z-0">
        <div className="aspect-video w-full max-h-[390px] md:max-h-[570px] overflow-hidden bg-background/50">
          <div
            ...
            <div className="flex flex-wrap gap-3 pt-4">
              ...
              <Button
                ...
                className={`gap-2 bg-background/20 backdrop-blur-sm border-foreground/20 hover:bg-background/30 ${
                  isInWatchlist ? "bg-foreground/20 border-foreground/40" : ""
                }`}
