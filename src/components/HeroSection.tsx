...
const HeroSection = () => {
  ...
  return (
    <div className="relative w-full overflow-hidden">
      <div className="h-[50vh] md:h-[85vh] w-full">
          ...
          <div className="max-w-2xl space-y-4 md:space-y-6 animate-fade-in">
            ...
            <div className="flex flex-wrap gap-3">
              <Link to={current.type === "movie" ? `/movie/${current.id}` : `/anime/${current.id}`}>
                <Button
                  size="sm"
                  className="md:size-lg bg-foreground text-background hover:bg-foreground/90 gap-2 text-xs md:text-base px-3 md:px-8 py-2 md:py-3"
                  onClick={() => {
                    console.log(
                      "[v0] Navigating to:",
              ...
              <Button
                size="sm"
                variant="outline"
                className="md:size-lg gap-2 bg-background/20 backdrop-blur-sm border-foreground/20 hover:bg-background/30 text-xs md:text-base px-3 md:px-6 py-2 md:py-3"
              >
